                        ...
                        <div role="tabpanel" id="auth" class="tab-pane">
                            ...
                            <table width="100%" class="table_form">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <label class="label-group"><input name="auth[member-index]" id="c_member" type="checkbox" onClick="selectInput('member')" <?php if ($auth['member-index']) echo 'checked'; ?> />会员管理</label>
                                        </td>
                                        <td align="left">
