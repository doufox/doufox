...
<table width="100%" cellspacing="0">
	...
	<td align="left"><input <?php if ($v['xiaosys']) echo 'class="selectform"';?> type="checkbox" name="table[]" value="<?php echo $v['Name']?>"/>
	  <?php if ($v['xiaosys']) echo '<font color="#f00">系统表</font>'; else echo '<font color="#369">其他表</font>';?></td>
	...
	?>
    <tr height="28">
	<td colspan="8" align="left">选择系统表&nbsp;&nbsp;<input name="selectform" class="cselectform" type="checkbox" onClick="setC()">
	&nbsp;&nbsp;<input type="submit" class="button" value="开始备份数据库" name="submit" ></td>
	</tr>
    <?php }?>
	</tbody>
</table>
