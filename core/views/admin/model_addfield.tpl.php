...
<div class="subnav">
	...
	<div class="table_form">
		...
		<tr>
			...
			<td>
                <input class="input-text" type="text" name="name" value="<?php echo $data['name']; ?>" size="30" id="name" onBlur="ajaxname()"/>
		...
		<tr>
			...
			<td>
                <input class="input-text" type="text" id="field" name="field" value="<?php echo $data['field']; ?>" size="30" <?php if ($data[fieldid]) { ?>disabled<?php } ?> />
		...
		<tr>
			<th>输入提示： </th>
			<td>
                <input class="input-text" type="text" name="tips" value="<?php echo $data['tips']; ?>" size="30"/>
		...
		<tr>
			<th>数据校验正则： </th>
			<td>
                <input class="input-text" type="text" name="pattern" id="pattern" value="<?php echo $data['pattern']; ?>" size="40"/>
                <select onChange="javascript:$('#pattern').val(this.value)" name="pattern_select">
		...
		<tr>
			<th>如未通过提示： </th>
			<td>
                <input class="input-text" type="text" name="errortips" value="<?php echo $data['errortips']; ?>" size="30"/>
		...
		<tr>
			<th>&nbsp;</th>
			<td>
                <input class="button" type="submit" name="submit" value="提交" onClick="$('#load').show()"/>
