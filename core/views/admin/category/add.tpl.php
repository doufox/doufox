    ...
    <div class="table_form">
        <form method="post" action="" id="myform" name="myform">
            ...
            <div class="col-tab">
                ...
                <tr>
                    <th>栏目图片：</th>
                    <td><span style="position: relative;"><input type="text" class="input-text" size="30" value="<?php echo $data['image']; ?>" name="data[image]" id="image" onmouseover="admin_command.preview_img('image')">
