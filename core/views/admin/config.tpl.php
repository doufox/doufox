    ...
    <div class="table_form">
        <form method="post" action="" class="form-inline">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class="<?php if ($type == 3) { ?>active<?php } ?>"><a href="#member" aria-controls="member" role="tab" data-toggle="tab">会员设置</a></li>
                <li role="presentation" class="<?php if ($type == 4) { ?>active<?php } ?>"><a href="#url" aria-controls="url" role="tab" data-toggle="tab">URL设置</a></li>
