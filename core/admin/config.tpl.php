...
<div class="table_form">
	...
	<div class="pad-10">
		<div class="col-tab">
				...
				<table width="100%" class="table_form">
					<tr>
						...
						<td>
							...
							<div class="onShow"><?php echo $string['SITE_NAME']; ?></div>
						</td>
					</tr>
					<tr>
						<th>桌面端主题样式： </th>
						<td>
							...
							<div class="onShow"><?php echo $string['SITE_THEME']; ?></div>
						</td>
					</tr>
					<tr>
						<th>移动端主题样式： </th>
						<td>
							...
							<select name="data[SITE_THEME_MOBILE]">
								<?php if (is_array($theme_mobile)) { foreach ($theme_mobile as $t) { if (is_dir(THEME_MOBILE_PATH . $t)) { ?>
							...
							<?php } ?>
							<label><input name="data[SITE_MOBILE]" type="radio" value="true" <?php if ($data['SITE_MOBILE']==true) { ?>checked<?php } ?> /> 打开</label>
							&nbsp;&nbsp;&nbsp;
							<label><input name="data[SITE_MOBILE]" type="radio" value="false" <?php if (empty($data['SITE_MOBILE'])) { ?>checked<?php } ?> /> 关闭</label>
							<div class="onShow"><?php echo $string['SITE_MOBILE']; ?></div>
						</td>
					</tr>
					<tr>
						<th>首页标题： </th>
					...
					<tr>
						...
						<td class="y-bg">
							...
							<div class="onShow"><?php echo $string['SITE_KEYWORDS']; ?></div>
						</td>
					</tr>
					<tr>
						<th>网站描述：</th>
						<td>
							...
							<div class="onShow"><?php echo $string['SITE_DESCRIPTION']; ?></div>
						</td>
					</tr>
				</table>
			</div>
				...
				<table width="100%" class="table_form ">
					...
					<tbody id="w_0">
						...
						<tr class="w_2">
							...
							<div class="onShow">默认字体文件：/static/fonts/elephant.ttf（若有中文请下载字体文件覆盖）</div></td>
						</tr>
						<tr class="w_2">
							<th>文字大小： </th>
            ...
            <div class="onShow">关闭后 后台顶部导航不显示会员连接，不需要会员功能建议关闭</div>
          </td>
				</tr>
				<tr>
					<th>新会员审核： </th>
				...
				<table width="100%" class="table_form">
					<tbody>
						<tr>
							...
							<div class="onShow">伪静态需要服务器支持并配置相关规则文件。更改模式后需  <a href="?s=admin&c=Content&a=updateurl">更新内容URL</a> 才生效</div></td>
						</tr>
					</tbody>
				...
				<table width="100%" class="table_form">
					<tr>
						...
						<td>
							...
							<div class="onShow"><?php echo $string['WEIXIN_MP_OPENED']; ?></div>
						</td>
					</tr>
					<tr>
						<th width="100">URL： </th>
						<td>
							...
							<div class="onShow"><?php echo $string['WEIXIN_MP_URL']; ?></div>
						</td>
					</tr>
					<tr>
						<th>Token： </th>
						<td>
							...
							<div class="onShow"><?php echo $string['WEIXIN_MP_TOKEN']; ?></div>
						</td>
					</tr>
					<tr>
						<th>加密密钥： </th>
						<td>
							...
							<div class="onShow"><?php echo $string['WEIXIN_MP_AESKEY']; ?></div>
						</td>
					</tr>
				</table>
			</div>
