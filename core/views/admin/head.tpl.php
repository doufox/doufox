<div class="header">
    ...
    <ul id="menu">
        ...
        <li id="_MP106">
            ...
            <ul>
                <li id="_MP1061"><a href="javascript:_MP(1061,'<?php echo url('admin/createhtml/index'); ?>');">生成首页</a></li>
                <li id="_MP1062"><a href="javascript:_MP(1062,'<?php echo url('admin/createhtml/category'); ?>');">生成栏目页</a></li>
                <li id="_MP1063"><a href="javascript:_MP(1063,'<?php echo url('admin/createhtml/show'); ?>');">生成内容页</a></li>
                <li class="menubtm"></li>
            </ul>
        </li>
