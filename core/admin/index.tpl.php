...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo ADMIN_DIR; ?>/css/backend.css" />
...
<div id="main">
  ...
  <div id="left">
    <div class="left-head">
      <span style="float:right;"><a href="javascript:void(0);" onClick="refresh();" class="refresh"><img src="<?php echo ADMIN_DIR; ?>/img/space.gif" alt="刷新菜单" title="刷新菜单" height="18" width="16" /></a></span>
