                        ...
                        <?php } if (is_array($list)) { foreach ($list as $t) { ?>
                            <tr >
                                ...
                                <?php 
                                    ...
                                    elseif ($t['formtype']=='textarea') {echo '多行文本';}
                                    elseif ($t['formtype']=='editor') {echo '编辑器';}
                                    elseif ($t['formtype']=='select') {echo '下拉选择框';}
                                    elseif ($t['formtype']=='radio') {echo '单选按钮';}
                                    elseif ($t['formtype']=='checkbox') {echo '复选框';}
                                    elseif ($t['formtype']=='image') {echo '单图上传';}
                                    elseif ($t['formtype']=='file') {echo '单文件上传';}
                                    elseif ($t['formtype']=='files') {echo '多文件上传';}
                                    elseif ($t['formtype']=='date') {echo '日期时间';}
                                    elseif ($t['formtype']=='fields') {echo '<span style="color:#f00;font-weight:700;">多字段组合</span>';}
