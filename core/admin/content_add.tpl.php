...
function ajaxtitle() {
	...
	$.post('<?php echo SITE_PATH;  echo ENTRY_SCRIPT_NAME; ?>?s=admin&c=content&a=ajaxtitle&id='+Math.random(), { title:$('#title').val(), id:<?php echo $data[id] ? $data[id] : 0; ?> }, function(data){ 
