...
p{font-size:12px; line-height:150%;padding:10px;line-height:18px;}
.table{width: 100%;height: 100%;display:table;}
.table-cell{display:table-cell;vertical-align: middle;}
.msg-container{max-width:420px; padding:20px 0;margin: -120px auto 0;}
#success{border:1px solid #A6DFA6; background:#EEF9EE;}
#success h1{color:#237E29;}
#success a:link,a:visited{color: #237E29;text-decoration: none;}
#success a:hover,a:active{color: #237E29;text-decoration: underline;}
#error {border:1px solid #FDBD77; background:#FFFDD7;}
#error h1{color:#f30;}
#error a:link,a:visited{color: #f30;text-decoration: none;}
#error a:hover,a:active{color: #0066FF;text-decoration: underline;}
.c_red{color:#FF0000;}
